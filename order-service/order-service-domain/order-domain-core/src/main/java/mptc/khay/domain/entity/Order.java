...
import mptc.khay.domain.exception.OrderDomainException;
import mptc.khay.domain.valueobject.*;
...
public class Order extends AggregateRoot<OrderId>{
    ...
    private void validateTotalPrice() {
        if (price == null || !price.isGreaterThanZero()){
            throw new OrderDomainException("Total price must be greate than zero");
        }
    }
    ...
    private void validateItemsPrice() {
        ...
        if (!price.equals(orderItemsTotalPrice)){
            throw new RuntimeException("Total price: " + price.amount() + " is not equal to order items total price: "+ orderItemsTotalPrice.amount());
        }
